...
docker rm -f track-service || echo "No started track service found"

docker run -it -p 9290:9290 --rm --name=track-service \
         -e ES_ENV=$ES_ENV \
         ...
         registry.cn-beijing.aliyuncs.com/easyassess/track-service \
         $CMD