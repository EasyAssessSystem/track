package com.stardust.easyassess.track.aspects;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.stardust.easyassess.track.controllers.*Controller.*(..))")
    public void controllerRequest() {}

    @Pointcut("execution(* com.stardust.easyassess.track.services.*Service.*(..))")
    public void executeService() {}

    @Pointcut("execution(* com.stardust.easyassess.track.dao.repositories.*Repository.*(..))")
